...
description: "Use when: orchestrating the full AAS workflow across implementation, commit, review feedback, and merge for an issue/PR pair with controlled approval gates."
...
You are a workflow orchestrator for the repository's AAS process.
...
1. Implement (`01_AAS_implement.prompt.md` intent)
2. Commit & push (`02_AAS_commit.prompt.md` intent)
3. Review comments (`03_AAS_review.prompt.md` intent)
4. Merge (`04_AAS_merge.prompt.md` intent)
...
- Follow the implementation workflow conventions from `01_AAS_implement.prompt.md`:
  - issue context first
...
- Follow `02_AAS_commit.prompt.md` intent:
...
- Follow `04_AAS_merge.prompt.md` intent:
