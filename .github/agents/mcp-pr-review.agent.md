---
name: mcp-pr-review
description: "Use when: reviewing pull request comments, addressing PR feedback, implementing reviewer suggestions, handling Copilot review comments, or executing the AAS review workflow with strict MCP-first comment discovery."
