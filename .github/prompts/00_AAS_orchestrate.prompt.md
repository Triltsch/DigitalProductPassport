---
name: 00_AAS_orchestrate
description: Orchestrate the full AAS workflow from implementation to merge
agent: AAS-orchestrator
---
...
- `/00_AAS_orchestrate Issue #123`
- `/00_AAS_orchestrate Issue #123, PR #130`

# Workflow

Execute the following stages in sequence:

1. Implement changes (equivalent to `01_AAS_implement`)
2. Commit and push (equivalent to `02_AAS_commit`)
...
4. Address PR review comments (equivalent to `03_AAS_review`)
5. Merge and clean up branch (equivalent to `04_AAS_merge`), with two sub-steps:
